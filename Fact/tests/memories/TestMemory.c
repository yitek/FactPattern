...
void testAlignedMemory() {
	...
	void* obj3 = TAlignedMemory_alloc(mm,6, MemoryKind_normal);
	Test_assert("TAlignedMemory.alloc"
		// 翻页，有第二页
		, mm->chunks[0]->page->next!=0 
		// 第二页没有后继页面
	...
	void* obj4 = TAlignedMemory_alloc(mm, 8, MemoryKind_normal);
	Test_assert("TAlignedMemory.re-alloc",obj4==obj3,"应该在被释放的内存上obj4==obj3");
	void* obj5 = TAlignedMemory_alloc(mm, 8, MemoryKind_normal);
	Test_assert("Memory.re-alloc", obj5 == obj4-8, "内存是连续的obj5==obj4-8");
	void* obj6 = TAlignedMemory_alloc(mm,6, MemoryKind_normal);
