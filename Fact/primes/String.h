...
extern "C" {
	...
	inline usize_t String_length(const String* self) { return self ? self->length : 0; }
	inline utiny_t* String_buffer(const String* self) { return self ? (utiny_t*)(self + 1) : 0; }
	...
	usize_t String_search(const String* search, const String* pattern, usize_t start,TMemory * mm) {
	...
	inline uint_t String__get__(const String* self, usize_t index) {
